...
// ThreadTableDeleteReplyChild1Result ...
type ThreadTableDeleteReplyChild1Result struct {
...
// DeleteReply ...
func (da *TableTypeThread) DeleteReply(db *sql.DB, id uint64, userID uint64) error {
	txErr := mingru.Transact(db, func(tx *sql.Tx) error {
		var err error
