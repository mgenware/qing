...
func (da *TableTypeThreadMsg) deleteReplyChild2(queryable mingru.Queryable, id uint64, userID uint64) error {
...
func (da *TableTypeThreadMsg) insertReplyChild1(queryable mingru.Queryable, content string, userID uint64, toUserID uint64, parentID uint64) (uint64, error) {
