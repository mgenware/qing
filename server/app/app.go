...
// MasterPageManager is an app-wide instance of handler.MasterPageManager.
...
func mustSetupTemplates(config *cfg.Config) {
	...
	MasterPageManager = handler.MustCreateMasterPageManager(templatesConfig.Dir, localizationConfig.Dir, localizationConfig.DefaultLang, assMgr, Logger, config)
}
